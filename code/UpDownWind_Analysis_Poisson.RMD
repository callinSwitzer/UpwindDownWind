...
# updn = full_join(updn1, updn2, by =  c("minute", "day", "side", "bee/wind orientation", "flight direction", "id"))
updn = full_join(updn1, updn2, by =  c("id", "minute", "day", "side", "flight direction"))
updn


# bee flow orientation is different in the two datasets
# View(updn[updn$`bee/wind orientation.x` != updn$`bee/wind orientation.y`, ])
